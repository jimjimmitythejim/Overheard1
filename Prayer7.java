...
public class Prayer7 extends AppCompatActivity {

    String text = "The world can overwhelm us with its noise,\n" +
            "And with its vast intrusions on our mind,\n" +
            "And frequently His voice is hard to hear,\n" +
            "Amid the clatter of our daily lives.\n" +
            "But do not be distracted from His path,\n" +
            "And do not give temptation any chance.\n" +
            "For even if His voice cannot be heard,\n" +
            "We know the basic outline of His plan,\n" +
            "As written in the Bible for us all.\n" +
            "If we follow that, we won't go wrong,\n" +
            "Then maybe He will come to us again,\n" +
            "And speak unto us as His very own.\n" +
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prayer7);
        ...
        goBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Prayer7.this, MainActivity.class);
                    ...
                    try {
                        ...
                        runOnUiThread(new Runnable() {
                         ...
                         //           }
                                ...
                                if (minutes == 3) {
                                    Intent intent = new Intent(Prayer7.this, HowManyPrayed.class);
                                    startActivity(intent);
                                }
