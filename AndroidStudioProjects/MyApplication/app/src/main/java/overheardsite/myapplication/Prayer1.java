...
public class Prayer1 extends AppCompatActivity {
    ...
    String text = "Lord, grant us tenacious winsome courage as we go through this day. When we are tempted to give up, help us to keep going. Grant us a cheerful spirit when things don't go our way. And give us courage to do whatever needs to be done. In Jesus' name, Amen.";
